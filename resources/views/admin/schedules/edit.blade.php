...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title text-bold" style="font-size:1.4rem">Update Schedule</h3>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('sub_title') ?? $schedule->sub_title }}"
                            ...
                            <option value="">--Select Speaker --</option>
                                @foreach ($speakers as $speaker )
                                    <option value="{{$speaker->id}}"
                                        @if($schedule->speaker_id == $speaker->id) selected @endif@enderror
                                    >{{ $speaker->name }}</option>
                                @endforeach
                        </select>
                        @error('speaker_id')
